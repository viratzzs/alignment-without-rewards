...
Usage:
    python run_test.py <model_name_or_path> [--max-samples N] [--max-tokens 750]
...
def main():
    ...
    # ── Load dataset ──────────────────────────────────────────────────────
    print(f"Loading test split of lucasmccabe/logiqa...")
    data = load_dataset("lucasmccabe/logiqa", split="test")
